                        ...
                        "tpms_detail" -> {
                            ...
                            RemoteRow(
                                ...
                                RemoteColumn(
                                    ...
                                    RemoteBox(
                                        modifier = RemoteModifier.weight(1.0f.rf)
                                    )
                                    RemoteText(
...
private fun TpmsOverviewResponsive(
    ...
    RemoteBox(
        ...
        TpmsCarCanvasResponsive(
            surfaceWidthDp = surfaceWidthDp,
            overviewHeightDp = overviewHeight
        )
...
@Composable
private fun TpmsCarCanvasResponsive(
    surfaceWidthDp: Float,
    overviewHeightDp: Float
) {
