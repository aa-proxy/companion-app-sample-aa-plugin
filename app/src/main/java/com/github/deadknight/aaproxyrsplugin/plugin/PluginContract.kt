...
enum class PluginDataKeys(val value: String) {
    ...
    @Json(name = "VEHICLE_ENERGY_FORECAST") VEHICLE_ENERGY_FORECAST("VEHICLE_ENERGY_FORECAST"),
...
data class VehicleEnergyForecast(
    val energyAtNextStop: VehicleEnergyPoint? = null,
    val distanceToEmpty: VehicleEnergyPoint? = null,
) : Parcelable

@JsonClass(generateAdapter = true)
@Parcelize
data class VehicleEnergyPoint(
    val distanceMeters: Long? = null,
    val arrivalBatteryEnergyWh: Long? = null,
) : Parcelable
